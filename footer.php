<div class="container-fluid">
        ...
        <script> 
            $(".about-slide-1").backstretch(["<?php echo GetAboutFirstSlideBg(); ?>"], { /*duration: 4000, fade: 750*/ });
            $(".what-we-do-height").backstretch(["<?php echo GetAboutSecondSlideBg(); ?>"], { /*duration: 4000, fade: 750*/ });
        </script>
