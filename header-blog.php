                    ...
                    <div class="row">
                         <header>
                            <div class="col-xs-6 masthead">
                                <a href="<?php echo $_SERVER["SELF"] . "/Blog" ?>"> <img class="img-responsive mast-img" src="<?php echo (strlen(get_theme_mod('mastheadimage_control_setting')) == 0) ? WPMEDIA . '/BLVDMasthead.png' : get_theme_mod('mastheadimage_control_setting'); ?>" alt="<?php bloginfo('name');?> | <?php bloginfo('description');?>" /> </a>
                            </div>
                            <div class="col-xs-6 top-right-nav">
                                <a id="sideMenuButton" href="#sideMenu"> <img class="fr left-gutter img-responsive" src="<?php echo WPMEDIA . '/MenuButtonBlack.png' ?>" alt="Open" /> </a>
