(function (root, factory) {
    ...
    */
    function Remodal($modal, options) {
        ...
        // Retrieve the desired html content that is specified and append it
        $.get(remodal.settings.externalSheet, function (extHtml) {
            // Set the html of the modal box
            if(remodal.settings.image != ""){
                var html = '<div class="row">' +
                                '<div style="margin-top: 15px;" class="col-xs-12 col-sm-6 col-md-6">' +
                                    '<div style="width: 100%;">' +
                                        '<img src="' + remodal.settings.image + '" alt="image" style="width: 100%; padding-right: 12px;" />' +
                                    '</div>' +
                                '</div>';
                //remodal.$modal.append(html); //First half of the html
            }
            remodal.$modal.append(extHtml); // Second half of the html
            if (remodal.settings.allowEmail) {
                //remodal.$modal.append('<div style="position:absolute; top:5px; right:5px; cursor:pointer;"> <a href="mailto:' + remodal.settings.email + '"><span class="glyphicon glyphicon-envelope mail-icon" aria-hidden="true"></span></a> <a onclick="window.print();"><span class="fa fa-print print-icon"></span></a> </div>');
                //remodal.$modal.append('<a href="mailto:' + remodal.settings.email + '"><span class="glyphicon glyphicon-envelope mail-icon" aria-hidden="true"></span></a></div>');
            }
        });
